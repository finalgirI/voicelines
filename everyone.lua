...
local AnimationSounds = {
	...
	-- ["110210471124945"] = { Sound = "110080538907600", Volume = 2.2, DelayTime = 0 }, -- Psychic Blast
	...
	["74423482356879"] = { Sound = "96559138398231", Volume = 2.5, DelayTime = 0, SimultaneousSounds = {
		{ Sound = "102648181914291", DelayTime = 3.6 },
	} }, -- Astral Projection
	...
	["95661493993334"] = { SimultaneousSounds = {
		...
		{ Sound = "102938095768537", DelayTime = 4.5, Volume = 1.9 },
