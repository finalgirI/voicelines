...
-- ============================================================
-- MYSELF MODE: Only process sounds/animations for the local player
-- ============================================================
...
local function tryReplaceSound(sound)
	...
	if not isLocalPlayerSound(sound) then return end
...
local AnimationSounds = {
	...
	["95661493993334"] = { SimultaneousSounds = {
		...
		{ Sound = "102938095768537", DelayTime = 4.2, Volume = 1.5 },
...
-- MYSELF MODE: Only hook local player, not other players
